...
from hsabackend.models.job import JobsServices, JobsMaterials
...
def add_total_and_disclaimer(pdf: FPDF, total, org_name):
    ...
    pdf.ln(5) 
    pdf.set_left_margin(0) # don't remove, or it will mess up the alignment pdf. (set_y(-20))  # Move to 20 units above the bottom
