...
from hsabackend.views.job_templates_materials import delete_cached_job_template_material, \
    get_job_template_material_table_data, create_job_template_material, delete_job_template_material


class materialViewTest(BaseTestCase):
