...
class GetListOfQuotesByOrgTests(APITestCase):
    ...
    @patch("hsabackend.utils.auth_wrapper.Organization.objects.get")
    @patch("hsabackend.views.generate_quote_pdf_view.Job")
    def test_invalid_filter(self, mock_job, org):
        mock_user = Mock()
        mock_user.is_authenticated = True
    ...
    @patch("hsabackend.utils.auth_wrapper.Organization.objects.get")
    @patch("hsabackend.views.generate_quote_pdf_view.Job")
    def test_success(self, mock_job, org):
        mock_user = Mock()
        mock_user.is_authenticated = True
...
class AcceptRejectQuoteTests(APITestCase):
    ...
    @patch("hsabackend.utils.auth_wrapper.Organization.objects.get")
    @patch("hsabackend.views.generate_quote_pdf_view.Job")
    def test_invalid_decision(self, mock_job, org):
        mock_user = Mock()
        mock_user.is_authenticated = True
...
class GetListFilteredTests(APITestCase):
    ...
    @patch("hsabackend.utils.auth_wrapper.Organization.objects.get")
    @patch("hsabackend.views.generate_quote_pdf_view.Job")
    def test_filter_created(self, mock_job, org):
        mock_user = Mock()
        mock_user.is_authenticated = True
...
class RetrieveQuoteEndpointVariants(APITestCase):
    ...
    @patch("hsabackend.utils.auth_wrapper.Organization.objects.get")
    @patch("hsabackend.views.generate_quote_pdf_view.Job")
    def test_retrieve_success_with_endpoint(self, mock_job, org, mock_client):
        mock_user = Mock()
        mock_user.is_authenticated = True
...
class AcceptRejectHappyPathTests(APITestCase):
    ...
    @patch("hsabackend.utils.auth_wrapper.Organization.objects.get")
    @patch("hsabackend.views.generate_quote_pdf_view.Job")
    def test_accept_flow(self, mock_job, org, mock_email):
        mock_user = Mock()
        mock_user.is_authenticated = True
    ...
    @patch("hsabackend.utils.auth_wrapper.Organization.objects.get")
    @patch("hsabackend.views.generate_quote_pdf_view.Job")
    def test_reject_flow(self, mock_job, org, mock_email):
        mock_user = Mock()
        mock_user.is_authenticated = True
...
class SendQuotePDFEmailTests(APITestCase):
    ...
    @patch("hsabackend.utils.auth_wrapper.Organization.objects.get")
    @patch("hsabackend.views.generate_quote_pdf_view.Job")
    def test_send_quote_success(self, mock_job, org, mock_email_class, mock_build):
        ...
        mock_build.assert_called_once_with(job, mock_org)
