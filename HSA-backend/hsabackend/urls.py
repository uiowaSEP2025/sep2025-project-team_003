...
from hsabackend.views.organizations import complete_onboarding, createOrganization, get_organization, \
    edit_organization
...
urlpatterns = [
    ...
    path("api/edit/customer/<int:customer_id>", edit_customer),
    path("api/delete/customer/<int:customer_id>", delete_customer),
    ...
    path("api/edit/contractor/<int:contractor_id>", edit_contractor),
    path("api/delete/contractor/<int:contractor_id>", delete_contractor),

    # request
    path("api/get/requests", get_org_request_data),
    path("api/delete/request/<int:request_id>", delete_request),
    path("api/approve/request/<int:request_id>", approve_request),
    ...
    path("api/edit/service/<int:service_id>", edit_service),
    path("api/delete/service/<int:service_id>", delete_service),
    ...
    path("api/edit/material/<int:material_id>", edit_material),
    path("api/delete/material/<int:material_id>", delete_material),

    # jobs
    path("api/get/jobs", get_job_table_data),
    path("api/get/jobs/exclude", get_job_excluded_table_data),
    path("api/get/job/<int:job_id>", get_job_individual_data),
    path("api/create/job", create_job),
    path("api/edit/job/<int:job_id>", edit_job),
    ...
    path("api/get/jobtemplate/<int:job_template_id>", get_job_template_individual_data),
    path("api/create/jobtemplate", create_job_template),
    path("api/edit/jobtemplate/<int:job_template_id>", edit_job_template),
    path("api/delete/jobtemplate/<int:job_template_id>", delete_job_template),

    # job_templates_services join
    path("api/get/jobtemplate/<int:job_template_id>/services", get_job_template_service_table_data),
    path("api/create/jobtemplate/<int:job_template_id>/service", create_job_template_service),
    ...
    path("api/get/jobtemplate/<int:job_template_id>/materials", get_job_template_material_table_data),
    path("api/create/jobtemplate/<int:job_template_id>/material", create_job_template_material),
    ...
    path("api/get/invoices", get_invoices),
    ...
    path("api/get/organization", get_organization),
    path("api/edit/organization", edit_organization),
    path("api/edit/organization/onboarding", complete_onboarding),


    # discounts
    path("api/get/discounts", get_discounts),
    path("api/edit/discount/<int:discount_id>", edit_discount),
    path("api/create/discount", create_discount),
    path("api/delete/discount/<int:discount_id>", delete_discount),

    # bookings
    path("api/get/bookings", get_booking_data),
    path("api/create/booking", create_event),
    path("api/edit/booking/<int:booking_id>", edit_event),
    path("api/delete/booking/<int:booking_id>", delete_event),
